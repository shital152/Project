...
public class FuploadDaoImpl implements FuploadDao {
	public static final String SEM1_CO="UPDATE FIRST_SEM_FACULTY SET CO=? WHERE ID=?";
	public static final String SEM1_CPP="UPDATE FIRST_SEM_FACULTY SET CPP=? WHERE ID=?";
	public static final String SEM1_COSM="UPDATE FIRST_SEM_FACULTY SET COSM=? WHERE ID=?";
	public static final String SEM1_PM="UPDATE FIRST_SEM_FACULTY SET PM=? WHERE ID=?";
	public static final String SEM1_CK="UPDATE FIRST_SEM_FACULTY SET CK=? WHERE ID=?";
	
	public static final String SEM2_DS="UPDATE SECOUND_SEM_FACULTY SET DS=? WHERE ID=?";
	public static final String SEM2_OOP="UPDATE SECOUND_SEM_FACULTY SET OOP=? WHERE ID=?";
	public static final String SEM2_SAD="UPDATE SECOUND_SEM_FACULTY SET SAD=? WHERE ID=?";
	public static final String SEM2_DC="UPDATE SECOUND_SEM_FACULTY SET DC=? WHERE ID=?";
	public static final String SEM2_BS="UPDATE SECOUND_SEM_FACULTY SET BS=? WHERE ID=?";
	
	public static final String SEM3_OS="UPDATE THIRD_SEM_FACULTY SET OS=? WHERE ID=?";
	public static final String SEM3_FSDP="UPDATE THIRD_SEM_FACULTY SET FSDP=? WHERE ID=?";
	public static final String SEM3_JAVA="UPDATE THIRD_SEM_FACULTY SET JAVA=? WHERE ID=?";
	public static final String SEM3_CN="UPDATE THIRD_SEM_FACULTY SET CN=? WHERE ID=?";
	public static final String SEM3_COOT="UPDATE THIRD_SEM_FACULTY SET COOT=? WHERE ID=?";
	
	public static final String SEM4_DBMS="UPDATE FOURTH_SEM_FACULTY SET DBMS=? WHERE ID=?";
	public static final String SEM4_CSC="UPDATE FOURTH_SEM_FACULTY SET CSC=? WHERE ID=?";
	public static final String SEM4_MT="UPDATE FOURTH_SEM_FACULTY SET MT=? WHERE ID=?";
	public static final String SEM4_EC="UPDATE FOURTH_SEM_FACULTY SET EC=? WHERE ID=?";
	public static final String SEM4_ELECTIVE_I="UPDATE FOURTH_SEM_FACULTY SET ELECTIVE=? WHERE ID=?";
	
	public static final String SEM5_AI="UPDATE FIFTH_SEM_FACULTY SET AI=? WHERE ID=?";
	public static final String SEM5_SPM="UPDATE FIFTH_SEM_FACULTY SET SPM=? WHERE ID=?";
	public static final String SEM5_SAS="UPDATE FIFTH_SEM_FACULTY SET SAS=? WHERE ID=?";
	public static final String SEM5_MIS="UPDATE FIFTH_SEM_FACULTY SET MIS=? WHERE ID=?";
	public static final String SEM5_ELECTIVE_II="UPDATE FIFTH_SEM_FACULTY SET ELECTIVE=? WHERE ID=?";
	...
	public int uploadFile(UploadBo ubo) throws Exception {
		...
		if(data.equalsIgnoreCase("CO")&&con!=null) {
			...
			psCo.setString(1,sc.getInitParameter("QUESTION")+fname);
			psCo.setInt(2, idval);
			result=psCo.executeUpdate();
			
		}else if(data.equalsIgnoreCase("CPP")&&con!=null) {
			psCpp=con.prepareStatement(SEM1_CPP);
			psCpp.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psCosm.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psJava.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psDbms.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psElective_I.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psAi.setString(1,sc.getInitParameter("QUESTION")+fname);
			psAi.setInt(2, idval);
			result=psAi.executeUpdate();
			
		}else if(data.equalsIgnoreCase("SPM")&&con!=null) {
			psSpm=con.prepareStatement(SEM5_SPM);
			psSpm.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psSas.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psMis.setString(1,sc.getInitParameter("QUESTION")+fname);
			...
			psElective_II.setString(1,sc.getInitParameter("QUESTION")+fname);
